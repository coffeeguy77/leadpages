    ...
    recs.push(
      outcomeRec({
        title: topic
          ...
          : 'Plan local search coverage with Scout',
        problem: topic
          ? 'You asked for a focused page/campaign, but there is not yet an approved landing-page plan for that request.'
        ...
        proposedChange: {
          ...
          note:
            'Atlas records the business outcome. Scout owns SEO/landing strategy; Forge executes when that capability ships. This recommendation does not create the page by itself.'
        },
        reason: topic
          ? 'Generated because you asked: “' +
            topic +
            '”. Approve means “pursue this landing outcome”; Discuss if you want to refine the brief first. Nothing is published until you apply and publish yourself.'
          : 'SEO pages are a proven workflow — Atlas recommends the outcome; Scout plans the strategy.',
