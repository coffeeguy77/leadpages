    ...
    recs.push(
      attachGuardian({
        ...
        proposedChange: {
          ...
          capabilityId: 'faq',
          sectionKey: 'faq',
          note: 'Phase 2 Forge can enable FAQ; add questions in Page editor'
        },
  ...
  if (!cta || /get in touch|contact us|learn more/i.test(String(cta))) {
    ...
    recs.push(
      attachGuardian({
        id: randomUUID(),
        specialist: 'atlas',
        title: 'Apply hero button from Site Knowledge',
        problem: 'Site Knowledge has a preferred CTA — the live hero may still use different wording.',
        evidence: ['goals.preferredCta is set', 'Forge can draft hero.cta in Phase 2'],
        proposedChange: {
          type: 'forge_draft',
          capabilityId: 'hero',
          sectionKey: 'hero',
        ...
        reason:
          'Approve to create a task, then Apply draft to write the hero button. Review in Page editor and Publish Live Site.',
        estimatedEffort: 'small',
