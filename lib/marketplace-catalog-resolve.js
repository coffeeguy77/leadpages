...
const MARKETING_ALIASES = {
  ...
  /* DB / marketing slugs — section config is sections.promotions; demos are demo-promotions*.html */
  'promotions-hero': {
  ...
  'promotions-inline': {
    ...
    summary: 'Drop urgency offers into the page body — cards or banners with weekly windows, limited spots, mystery reveals and more. Same Promotions Engine as the App Command Centre.',
    hero_image_url: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1400&h=560&fit=crop&q=80'
  },
  'email-campaigns': {
    sectionKey: null,
    platform: true,
