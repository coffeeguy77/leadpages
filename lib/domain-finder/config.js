...
const DEFAULTS = {
  ...
  targetAvailable: envInt('DOMAIN_FINDER_TARGET', 12),
  maxGenerationRounds: envInt('DOMAIN_FINDER_MAX_ROUNDS', 2),
  candidatesPerRound: envInt('DOMAIN_FINDER_CANDIDATES_PER_ROUND', 14),
  maxDomainsChecked: envInt('DOMAIN_FINDER_MAX_CHECKS', 54),
  availabilityBatchSize: envInt('DOMAIN_FINDER_BATCH', 18),
  // Leave headroom under Vercel 60s (and Brain timeouts).
  deadlineMs: envInt('DOMAIN_FINDER_DEADLINE_MS', 48000),
  aiGenerateTimeoutMs: envInt('DOMAIN_FINDER_AI_GENERATE_MS', 18000),
  aiRankTimeoutMs: envInt('DOMAIN_FINDER_AI_RANK_MS', 12000),
  minResultsToSkipExtraRound: envInt('DOMAIN_FINDER_MIN_OK', 6),
