...
const TRADE_LEAKAGE_TERMS = Object.freeze([
  ...
  { id: 'what_we_fix', pattern: /\bwhat we fix\b/i },
  { id: 'kitchen_sink', pattern: /\bkitchen sink\b/i },
  { id: 'one_call_sorts', pattern: /\bone call sorts the lot\b/i },
  { id: 'five_star_212', pattern: /\b212 five-star\b/i },
  { id: 'tell_us_the_problem', pattern: /\btell us the problem\b/i }
]);
...
function detectIndustryLeakage(conceptOrConfig, opts) {
  ...
  const forbidTrade =
    ...
    /jewellery|jewelry|retail|hobby|boutique|cafe|hospitality|agency|wellness|health/.test(industry);
