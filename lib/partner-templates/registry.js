...
const PARTNER_TEMPLATES = [
  ...
  },
  {
    id: 'localwebsiteco',
    short: 'Local',
    label: 'Local Website Co.',
    tagline: 'Personal local partner sites',
    description: 'Warm local partner microsites with personal support, industry demos, clear pricing and LeadPages platform trust.',
    mood: 'Warm & local',
    fonts: 'Young Serif + Figtree',
    preview: 'linear-gradient(160deg,#f9f7f2 0%,#e36b21 45%,#1D2B4D 100%)'
  }
];
