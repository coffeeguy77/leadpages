...
function brandLinkHtml(c, ctx) {
  ...
  if (ctx && ctx.logoUrl) {
    return '<a href="#top" class="ch-brand ch-brand-lockup ch-brand-logo-only">'
      ...
      + '<img src="' + ctx.logoUrl + '" alt="' + esc(brand) + '" class="ch-brand-img">'
      + '</span>'
      + '</a>';
  }
...
function heroVisual(c, ctx) {
  ...
  if (ctx && ctx.logoUrl) {
    return '<div class="ch-hero-visual ch-hero-frame ch-hero-logo-wrap">'
      ...
      + '<img src="' + ctx.logoUrl + '" alt="' + esc(brand) + ' logo" class="ch-hero-logo" loading="eager">'
      + '</span>'
      + '</div>';
  }
...
function heroSection(c, ctx) {
  const hero = c.hero || {};
  const brand = brandName(c);
  const heroLogo = (ctx && ctx.logoUrl)
    ? '<div class="ch-hero-logo-mark"><img src="' + ctx.logoUrl + '" alt="' + esc(brand) + ' logo" class="ch-hero-mark-logo" loading="eager"></div>'
    : '';
  return chapter('bg', ''
...
function bioVisual(p, ctx) {
  ...
  if (ctx && ctx.logoUrl) {
    return '<div class="ch-bio-logo-wrap">'
      ...
      + '<img src="' + ctx.logoUrl + '" alt="' + esc(brand) + ' logo" class="ch-bio-logo" loading="lazy">'
      + '</span>'
      + '</div>';
  }
