/**
 * Premium partner theme — thin stroke icons (concept-accurate).
 */
const S = '1.25';
...
function connectedFlowArt() {
  return '<svg class="prm-flow-connectors" viewBox="0 0 400 96" preserveAspectRatio="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">'
    ...
    + '<path d="M308 36 C308 68 148 68 148 86" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="4 4"/>'
    + '</svg>';
}
...
/** Web Culture brand mark — cloud with up/down arrows */
function webcultureCloudMark() {
  return '<span class="wc-footer-cloud-mark" aria-hidden="true">'
    + '<svg class="wc-footer-cloud-svg" viewBox="0 0 56 40" xmlns="http://www.w3.org/2000/svg">'
    + '<path fill="currentColor" d="M14 32h28a9 9 0 0 0 1.6-17.9A11.5 11.5 0 0 0 24.5 5.5 12.5 12.5 0 0 0 9.5 22.5 10 10 0 0 0 14 32z"/>'
    + '<path fill="currentColor" d="M21 25.5V16.5l-3.5 3.5V16l7-7 7 7v4l-3.5-3.5v9z"/>'
    + '<path fill="currentColor" d="M35 14.5v9l3.5-3.5v4l-7 7-7-7v-4l3.5 3.5v-9z"/>'
    + '</svg></span>';
}
