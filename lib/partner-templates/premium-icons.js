...
/** Dashed curve: CRM → under Your Website → New Customers */
function connectedFlowArt() {
  return '<svg class="prm-flow-connectors" viewBox="0 0 400 88" preserveAspectRatio="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">'
    + '<path d="M30 24 H370" fill="none" stroke="currentColor" stroke-width="1.25" opacity="0.22"/>'
    + '<path d="M330 24 C330 58 150 58 150 76" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="5 4"/>'
    + '</svg>';
}
