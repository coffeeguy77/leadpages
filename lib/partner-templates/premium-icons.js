...
function connectedFlowArt() {
  return '<svg class="prm-flow-connectors" viewBox="0 0 500 96" preserveAspectRatio="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">'
    + '<path d="M42 36 H458" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="4 4"/>'
    + '<path d="M458 36 L452 33 M458 36 L452 39" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>'
