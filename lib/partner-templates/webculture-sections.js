...
function brandLinkHtml(c, ctx) {
  ...
  const wordmark = rest
    ? '<span class="wc-wordmark"><span class="wc-wordmark-a">' + esc(first.toUpperCase()) + '</span>'
      + '<span class="wc-wordmark-b">' + esc(rest.toUpperCase()) + '</span></span>'
    : '<span class="wc-wordmark"><span class="wc-wordmark-a">' + esc(brand.toUpperCase()) + '</span></span>';
...
function heroSection(c, ctx) {
  ...
  return '<section class="wc-section wc-hero" id="top">'
    + shell(
      ...
      + '<h1 class="wc-display">' + highlightHeadline(hero.headline, hero.highlightedPhrase) + '</h1>'
    ...
    + shell(
      ...
      + (showTestimonials && featured
        ? '<div class="wc-testimonial-col">'
          ...
          + prm.ReviewCard(featured, c.contact, c.metrics, c.social)
          + '</div>'
