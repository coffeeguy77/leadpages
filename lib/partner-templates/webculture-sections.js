...
function wordmarkHtml(brand) {
  ...
  if (parts.length >= 2) {
    return '<span class="wc-wordmark"><span class="wc-wordmark-web">' + esc(parts[0].toUpperCase()) + '</span> '
      + '<span class="wc-wordmark-culture">' + esc(parts.slice(1).join(' ').toUpperCase()) + '</span></span>';
  }
  return '<span class="wc-wordmark"><span class="wc-wordmark-web">' + esc(String(brand).toUpperCase()) + '</span></span>';
}
...
function footerBlock(ctx, c) {
  ...
  return '<footer class="wc-footer">'
    + shell(
      ...
      + '<div class="wc-footer-brand">' + brandHtml + '</div>'
      ...
      + '<span class="wc-footer-lp-logo leadpages-logo" data-lp-logo="auto" data-lp-logo-ink="light" data-lp-logo-pulse="false" role="img"></span>'
      + '</a>'
      + '</div>'
      + '</div>'
