...
const KEEP_MAX = 40;
const LIST_COLS_FULL = 'id,label,created_at,size_bytes,source,actor_user_id,config_hash';
const LIST_COLS_MID = 'id,label,created_at,size_bytes';
const LIST_COLS_BASIC = 'id,label,created_at';
