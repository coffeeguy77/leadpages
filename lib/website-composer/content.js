    ...
    switch (key) {
      ...
      case 'heroSlider':
        put(
          key,
          {
            cta,
            slides: [
              { heading, subText: subheading, cta },
              {
                heading: name,
                subText: brief.specialisation || brief.industry,
                cta
              }
            ]
          },
      ...
      case 'featuredProjects':
        put(
          key,
          {
            ...
            eyebrow: profile.profileId === 'coffee-event' ? 'Event gallery' : '',
            intro: 'Highlights from ' + name,
            projects: [
              {
                title: imageBriefs.galleryImage1 || 'Featured project',
                tag: profile.profileId === 'coffee-event' ? 'Wedding' : '',
                location: loc,
              ...
              },
              {
                ...
                tag: profile.profileId === 'coffee-event' ? 'Corporate' : '',
                location: loc,
                text: 'A second showcase moment',
                imageBrief: imageBriefs.galleryImage2
              },
              {
                title: profile.profileId === 'coffee-event' ? 'Festival service' : 'Studio highlight',
                tag: profile.profileId === 'coffee-event' ? 'Festival' : '',
                location: loc,
                text: 'Another proof point for ' + name,
          ...
          key,
          {
            ...
            intro:
              profile.profileId === 'jewellery'
                ...
                : 'Tell us what you need and we will confirm the next step.',
            cta,
      ...
      case 'projectFeed':
        put(
          key,
          {
            heading: key === 'jobsFeed' ? 'Recent jobs' : 'Project feed',
            items: [
              { title: 'Recent project', text: 'Completed work for a local client in ' + (loc || 'the area') + '.' },
              { title: 'Another highlight', text: 'Clean delivery with clear updates throughout.' }
            ]
          },
          PROVENANCE.AI_GENERATED
        );
