...
function baseFoundation(partial) {
  return {
    ...
    rendererShellId: 'landing-shell-v1',
    pageSkeleton: ['home'],
    navigationDefaults: [
...
const FOUNDATIONS = Object.freeze([
  ...
  baseFoundation({
    ...
    supportedSectionKeys: [...CORE_SECTIONS, 'igProjectFeed', 'serviceProcess'],
    requiredSectionKeys: ['hero', 'services', 'featuredProjects', 'quote', 'footer'],
    optionalSectionKeys: ['why', 'reviews', 'specialOffer', 'instaGallery', 'crew', 'faq', 'serviceProcess'],
    defaultSectionOrder: [
      'hero',
      'featuredProjects',
      'services',
  ...
  baseFoundation({
    ...
    requiredSectionKeys: ['hero', 'services', 'featuredProjects', 'quote', 'footer'],
    optionalSectionKeys: ['why', 'reviews', 'specialOffer', 'faq', 'instaGallery', 'crew'],
    defaultSectionOrder: [
      'hero',
      'featuredProjects',
      'services',
  ...
  baseFoundation({
    ...
    supportedSectionKeys: [...CORE_SECTIONS, 'beforeAfter', 'serviceProcess'],
    requiredSectionKeys: ['hero', 'services', 'quote', 'footer'],
    optionalSectionKeys: ['why', 'reviews', 'specialOffer', 'faq', 'beforeAfter', 'serviceProcess'],
    defaultSectionOrder: [
      'hero',
      'services',
      'why',
