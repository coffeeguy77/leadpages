...
const RECIPES = Object.freeze([
  ...
  baseRecipe({
    ...
    apps: [
      ...
      { sectionKey: 'specialOffer', role: 'packages' },
      { sectionKey: MK.BOOKING, role: 'conversion' },
    ...
    requiredSectionKeys: ['hero', 'services', 'featuredProjects', 'quote', 'faq', 'footer'],
  ...
  baseRecipe({
    ...
    apps: [
      { sectionKey: MK.FEATURED_PROJECTS, role: 'gallery' },
      { sectionKey: MK.INSTAGRAM_FEED, role: 'social' },
      { sectionKey: MK.BOOKING, role: 'appointment' }
    ],
    sectionOrder: [
      'hero',
      'featuredProjects',
  ...
  baseRecipe({
    ...
    layoutIds: ['photo-proof', 'premium-showcase', 'ba-hero-slider', 'authority-builder'],
