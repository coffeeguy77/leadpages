...
const UNSPLASH = {
  ...
  aboutShaun: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=1200&q=80',
  trustPhoto: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=1200&q=80',
  contactPhoto: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=1200&q=80'
};
...
function demoFromContent(demo, index) {
  ...
  return {
    ...
    image: demo.thumbnail || fallback.image,
...
function buildLocalWebsiteCoCopy(content) {
  ...
  return {
    ...
    trust: {
      ...
      image: partner.headshotUrl || UNSPLASH.trustPhoto
    },
    faqs: {
      eyebrow: 'FAQ',
    ...
    contact: {
      ...
      image: partner.headshotUrl || UNSPLASH.contactPhoto,
      phone: contact.phone || '',
      email: contact.email || ''
    },
    footer: {
