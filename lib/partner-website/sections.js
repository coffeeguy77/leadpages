...
const { publicPartnerIntro, publicPhotoAlt, placeholderInitial, publicPartnerBio } = require('./public-identity');
...
function biographySection(content) {
  ...
  const bioIntro = publicPartnerBio(b.shortIntro, intro, { agencyName: p.agencyName, displayName: p.displayName });
  return '<section class="pt-biography" id="partner"><div class="pt-wrap pt-bio-grid">'
    ...
    + (bioIntro ? '<p class="pt-bio-intro">' + esc(bioIntro) + '</p>' : '')
