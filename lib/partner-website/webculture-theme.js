...
const WEBCULTURE_PROCESS = [
  ...
  { step: 3, title: 'Build', icon: 'build', description: 'Create the website on LeadPages and connect forms, tools and lead capture.' },
  ...
  { step: 5, title: 'Launch', icon: 'launch', description: 'Go live with hosting in place and ongoing local support behind the platform.' }
];
...
const LEAD_FLOW_STEPS = [
  ...
  { key: 'customers', label: 'New Customers', sub: '', icon: 'customers', branch: true }
];
