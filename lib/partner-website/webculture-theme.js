...
const LEAD_FLOW_STEPS = [
  { key: 'visitors', label: 'Visitors', sub: 'Google, Social', icon: 'search' },
  { key: 'website', label: 'Your Website', sub: '', icon: 'globe' },
  { key: 'enquiries', label: 'Enquiries', sub: 'Forms & Bookings', icon: 'form' },
  { key: 'crm', label: 'CRM & Follow-up', sub: '', icon: 'crm' },
  { key: 'customers', label: 'New Customers', sub: '', icon: 'check', highlight: true }
];
