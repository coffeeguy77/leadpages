...
function buildWebCultureWebsiteProfile() {
  return {
    ...
    positioning: {
      ...
      heroHighlight: '',
      heroSupporting: 'Work directly with Web Culture to create a professional website that builds trust, generates enquiries and grows with your business. Explore real live demos before you commit, then launch on the complete LeadPages platform with local support every step of the way.',
...
function buildWebCultureShowcasePatch() {
  return {
    showcase_headline: 'Websites that work harder for your business.',
    showcase_config: {
      intro: 'Work directly with Web Culture to create a professional website that builds trust, generates enquiries and grows with your business. Explore real live demos before you commit, then launch on the complete LeadPages platform with local support every step of the way.',
