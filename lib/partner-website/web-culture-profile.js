...
function buildWebCultureWebsiteProfile() {
  return {
    ...
    positioning: {
      ...
      heroHeadline: 'Beautiful websites. Smarter systems. Better business.',
      heroHighlight: '',
      heroSupporting: 'Your website should do more than look good. We create websites that showcase your business, capture enquiries, connect with your CRM and continue working long after you\u2019ve finished your day.',
...
function buildWebCultureShowcasePatch() {
  return {
    showcase_headline: 'Beautiful websites. Smarter systems. Better business.',
    showcase_config: {
