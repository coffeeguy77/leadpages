...
function buildWebCultureWebsiteProfile() {
  return {
    ...
    positioning: {
      ...
      heroHighlight: '',
      heroSupporting: 'Work directly with {{partnerDisplayName}}, your local website partner in {{primarySuburb}}. Get a professionally built website, live demos you can explore, and ongoing support from someone who understands your business.',
