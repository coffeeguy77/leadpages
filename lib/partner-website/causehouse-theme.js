...
function buildCausehouseCopy(content) {
  ...
  return {
    ...
    partner: {
      ...
      heading: applyTemplate('Work directly with {{partnerDisplayName}}.', vars),
      roleLine: applyTemplate('Your {{primaryRegion}} website partner and ongoing point of contact.', vars)
    },
    serviceArea: {
