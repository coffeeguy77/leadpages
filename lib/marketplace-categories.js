...
const CATEGORIES = [
  ...
  { slug: 'images-media', name: 'Images & Media', blurb: 'Premium galleries and photography-led visual collections.', sort_order: 55 },
  { slug: 'platform-tools', name: 'Platform tools', blurb: 'Editor workspaces for SEO, Advertising and partner operations — not page sections.', sort_order: 60 }
];
...
const SECTION_CATEGORY = {
  ...
  faq: 'core-content',
  quote: 'core-content',
  onlineQuote: 'core-content',
  customHtml: 'platform-tools',
  ...
  promotions: 'trust-conversion',
  scrollingSponsorBanner: 'trust-conversion',
  instaGallery: 'social-instagram',
  igProjectFeed: 'social-instagram',
  productCollection: 'core-content',
  clientLogos: 'trust-conversion',
  bookingCta: 'trust-conversion',
  brandStory: 'core-content',
  packageCompare: 'core-content',
  featureStrip: 'core-content',
  footer: 'core-content',
  seoText: 'core-content',
  searchCanvas: 'core-content',
  seoCommand: 'platform-tools',
  advertising: 'platform-tools'
};
