...
const RECIPES = Object.freeze([
  ...
  },
  {
    ...
    actions: ['refresh_sitemap', 'auto_fix_safe', 'schema_patch', 'open_editor_seo', 'create_task'],
    autoFixAllowed: true,
  ...
  // ── Recipes 11–20 (Phase 2–4; config/Maps detectors live where noted) ──
  {
    id: 'listings_nap_gap',
  ...
  },
  {
    ...
    actions: ['schema_patch', 'auto_fix_safe', 'create_task'],
    autoFixAllowed: true,
