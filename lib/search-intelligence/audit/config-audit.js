...
function auditSiteConfig(cfg, meta) {
  ...
  if (!siteTitle) {
    pushFinding(findings, {
      ...
      plainLanguage:
        'Search results need a clear title. Add an SEO title in SEO Command Centre → Home so Google is not guessing from the business name alone.',
      severity: 'high',
      editorSection: 'seoHome',
  ...
  if (!siteDesc) {
    pushFinding(findings, {
      ...
      plainLanguage:
        'A short meta description helps clicks from search. Add it in SEO Command Centre → Home.',
      severity: 'medium',
      editorSection: 'seoHome',
