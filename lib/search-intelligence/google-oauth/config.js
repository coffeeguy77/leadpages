...
function configHint(providerId) {
  ...
  return (
    ...
    ' / ' +
    p.clientSecretEnv +
    ' on the platform (or reuse GOOGLE_OAUTH_CLIENT_* / GOOGLE_ADS_CLIENT_*), then redeploy. Ensure the OAuth client allows this callback URI and Search Console / Analytics scopes.'
  );
}
