...
async function assertPremiumSeoEntitled(siteId, opts) {
  ...
  return {
    ...
    product: APP_SLUG,
    message:
      'Premium SEO unlocks live competitor discovery, SERP rivals, keyword gap, you-vs-rival comparison, backlinks, and paid ads research. Add the Premium SEO app to this site to continue.',
    app: app
      ? {
          id: app.id,
          slug: app.slug,
  ...
  return {
    premiumSeo: {
      ...
      tagline:
        ...
        'Live competitor research via DataForSEO — discovery, SERP rivals, keyword gap, you-vs-rival, backlinks, and paid ads.',
