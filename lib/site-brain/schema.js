...
/**
 * Search Digital Twin — strategy state for Search Intelligence agents.
 * Observations live in si_* warehouse tables; this holds decisions and maps.
 * See docs/search-intelligence/09-SEARCH-DIGITAL-TWIN.md
 */
function emptySearchIntelligence() {
  return {
    schemaVersion: '1.0',
    businessTruth: {},
    services: [],
...
function emptySnapshot(siteId, accountId) {
  return {
    ...
    locations: {},
    seo: {},
    searchIntelligence: emptySearchIntelligence(),
    conversion: {},
    content: {},
    imagery: {},
    marketplace: {},
...
function validateSnapshot(snap) {
  ...
  if (!snap.searchIntelligence || typeof snap.searchIntelligence !== 'object') {
    snap.searchIntelligence = emptySearchIntelligence();
  }
