...
const STAFF_FORMATS = ['slip', 'receipt', 'thermal', 'day_run', 'prep', 'pick_list', 'allocation'];
 ...
 * @param {string} payload.format - slip|receipt|thermal|day_run|prep|pick_list|allocation
