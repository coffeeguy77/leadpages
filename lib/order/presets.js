...
const PRESETS = {
  butcher: {
    ...
    sample_categories: [
      ...
      { name: 'Smallgoods', slug: 'smallgoods' },
      { name: 'Sauces & Extras', slug: 'extras' }
    ],
    sample_products: [
      {
        name: 'BEEF - Rib Eye Steak',
        slug: 'beef-rib-eye-steak',
        category_slug: 'beef',
    ...
    sample_templates: [
      ...
      {
        category: 'abandoned_cart_2',
        name: 'Abandoned cart follow-up',
        channel: 'sms',
        body:
          'Hi {{first_name}}, last call — your cart at {{business_name}} is still open. Finish checkout: {{checkout_link}}'
      },
      {
