...
/** Best e164 from stored customer phone_e164 and/or display phone (spaces OK). */
function customerPhoneE164(customer) {
  if (!customer) return '';
  return normaliseAuPhone(customer.phone_e164 || customer.phone || '');
}

module.exports = { normaliseAuPhone, displayAuPhone, phonesMatch, customerPhoneE164 };
