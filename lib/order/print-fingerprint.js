...
function buildPrintFingerprint(format, data) {
  ...
  if (format === 'prep' || format === 'procurement') {
    ...
    var { classifyOrderExceptions, filterExceptionOrders } = require('./exceptions');
    ...
    canonical = {
      ...
      orders: list.map(function (o) {
        ...
        var meta = o.important_meta && typeof o.important_meta === 'object' ? o.important_meta : {};
        return {
          id: o.id,
          order_number: o.order_number || '',
          status: o.status || '',
          ...
          is_important: !!o.is_important,
          important_type: meta.type || null,
          important_colour: meta.colour || null,
          important_reason: meta.reason || '',
          flags: c.flags.slice().sort(),
          deposit_required_cents: Number(o.deposit_required_cents) || 0,
          deposit_paid_cents: Number(o.deposit_paid_cents) || 0,
          has_unknown_prices: !!o.has_unknown_prices
        };
      })
    };
  ...
  return {
    ...
    order_count: format === 'exceptions' ? lineCount : orders.length,
    line_count: lineCount,
    payload_summary: {
      v: FINGERPRINT_VERSION,
      format: format,
      order_numbers: (format === 'exceptions' && canonical.orders
        ? canonical.orders
        : orders
      )
        .map(function (o) {
