...
(function () {
  ...
  function addStyles() {
    ...
    s.textContent = [
      ...
      '.mp-info-hero .feat-hero-grid{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(280px,1fr);gap:clamp(22px,4vw,40px);align-items:stretch}',
      '.mp-info-hero .feat-hero-copy{min-width:0}',
      '.mp-info-hero .feat-hero-media{min-width:0;display:flex;align-self:stretch;min-height:280px}',
      '.mp-info-hero .himg{margin:0;border-radius:18px;overflow:hidden;border:1px solid rgba(255,255,255,.12);box-shadow:0 28px 64px rgba(0,0,0,.28);background:rgba(0,0,0,.15);position:relative;flex:1 1 auto;width:100%;min-height:100%;align-self:stretch}',
      '.mp-info-hero .himg img{position:absolute;inset:0;width:100%;height:100%;max-height:none;min-height:0;object-fit:cover;display:block}',
      '.mp-info-hero .himg-placeholder{flex:1 1 auto;width:100%;min-height:100%;border-radius:18px;background:linear-gradient(135deg,rgba(168,74,94,.35),rgba(47,65,58,.8));border:1px solid rgba(255,255,255,.1);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,.55);padding:24px;text-align:center}',
      '@media(max-width:900px){.mp-info-hero .feat-hero-grid{grid-template-columns:1fr}.mp-info-hero .feat-hero-media{order:-1;min-height:220px}.mp-info-hero .himg{min-height:220px;aspect-ratio:16/10}.mp-info-hero .himg img{position:absolute}}',
