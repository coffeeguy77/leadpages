...
function applyCfg(C){
    ...
    try{
      ...
      if(!__PV){ document.querySelectorAll('.lp-seclabel').forEach(function(__x){ __x.remove(); }); document.documentElement.classList.remove('lp-preview-mode'); }
        ...
        if(!document.getElementById('lp-preview-fit-css')){ var __pf=document.createElement('style'); __pf.id='lp-preview-fit-css'; __pf.textContent='html.lp-preview-mode,html.lp-preview-mode body{min-height:0!important;height:auto!important}html.lp-preview-mode body{padding-bottom:0!important}'; document.head.appendChild(__pf); }
