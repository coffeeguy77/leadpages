...
function applyCfg(C){
  ...
  var _open=function(){ try{ window.__hnmKeepOpen=true; document.documentElement.classList.add('hnm-menu-open'); }catch(_eK){} _bdEl.classList.add('hnm-open'); _pn.classList.add('hnm-open'); _btn.classList.add('is-open'); _btn.setAttribute('aria-expanded','true'); };
  var _close=function(){ try{ window.__hnmKeepOpen=false; document.documentElement.classList.remove('hnm-menu-open'); }catch(_eK2){} _bdEl.classList.remove('hnm-open'); _pn.classList.remove('hnm-open'); _btn.classList.remove('is-open'); _btn.setAttribute('aria-expanded','false'); };
