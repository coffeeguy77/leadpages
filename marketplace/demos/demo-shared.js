...
(function(){
  ...
  function applyCfg(C){
    ...
    if(C.logo){ var L=C.logo, brands=document.querySelectorAll('a.brand'); var _lhd=Math.max(20,Math.min(320,(L.heightPx?L.heightPx:Math.round(40*(L.scale||1)))||44)); var _lhm=Math.max(16,Math.min(200,(L.heightPxM?L.heightPxM:Math.round(_lhd*0.72)))); var _lbg=(L.bg&&L.bg!=='transparent')?L.bg:'transparent'; var _lpad=(L.pad!=null?L.pad:(_lbg!=='transparent'?8:0)); var _lrad=(L.radius!=null?L.radius:(_lbg!=='transparent'?12:0)); var _lp=L.position||'left'; var _hs=L.headerStyle||(L.float?'float':'solid-sticky'); var _hbg=(L.headerBg&&L.headerBg!=='')?L.headerBg:''; var _hop=L.headerBgOpacity; var _hopa=1; if(_hop!=null&&_hop!==''){ var _hopn=parseFloat(_hop); if(!isNaN(_hopn)) _hopa=Math.max(0,Math.min(100,_hopn))/100; } function _lgHexRgba(hex,a){ var m=/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.exec(String(hex||'').trim()); if(!m) return ''; var h=m[1]; if(h.length===3) h=h[0]+h[0]+h[1]+h[1]+h[2]+h[2]; var n=parseInt(h,16); return 'rgba('+((n>>16)&255)+','+((n>>8)&255)+','+(n&255)+','+a+')'; } var _hbgBase=_hbg||((_hopa<1)?'#0b1220':''); var _hbgCss=_hbgBase?(_hopa<=0?'transparent':(_hopa<1?(_lgHexRgba(_hbgBase,_hopa)||_hbgBase):_hbgBase)):''; var _pos='sticky',_top=';top:0',_bg=(_hbgCss?(';background:'+_hbgCss):''); if(_hs==='solid-scroll'){ _pos='relative'; _top=''; } else if(_hs==='float'){ _pos='absolute'; _top=';top:0;left:0;right:0'; _bg=';background:transparent;box-shadow:none'; } else if(_hs==='shrink'){ _pos='sticky'; _bg=';background:transparent;box-shadow:none'; } var _stTopOn=L.headerStrokeTopOn===true; var _stBotOn=L.headerStrokeBottomOn===true; var _stTopW=Math.max(0,Math.min(16,+(L.headerStrokeTopWidth!=null?L.headerStrokeTopWidth:2)||0)); var _stBotW=Math.max(0,Math.min(16,+(L.headerStrokeBottomWidth!=null?L.headerStrokeBottomWidth:2)||0)); var _stTopC=(L.headerStrokeTopColor&&String(L.headerStrokeTopColor).trim())||'#ffffff'; var _stBotC=(L.headerStrokeBottomColor&&String(L.headerStrokeBottomColor).trim())||'#ffffff'; var _stroke=';border-top:'+(_stTopOn&&_stTopW>0?(_stTopW+'px solid '+_stTopC):'0')+';border-bottom:'+(_stBotOn&&_stBotW>0?(_stBotW+'px solid '+_stBotC):'0'); var _hdrBase='header.site{position:'+_pos+_top+';z-index:60'+_bg+_stroke+'}'; var _shrinkBg=_hbgCss||(_hbgBase?(_lgHexRgba(_hbgBase,0.94)||_hbgBase):'rgba(10,12,18,.94)'); var _shrinkCss=(_hs==='shrink')?('header.site{transition:background .25s,box-shadow .25s}header.site img.lp-logo{transition:height .25s}'+'header.site.lp-shrunk{background:'+_shrinkBg+';box-shadow:0 6px 24px rgba(0,0,0,.28)}'+'header.site.lp-shrunk .bar{min-height:0;padding-top:6px;padding-bottom:6px}'+'header.site.lp-shrunk a.brand{margin-left:0;margin-right:auto}'+'header.site.lp-shrunk img.lp-logo{height:'+Math.min(_lhd,52)+'px}'):''; var _hdrCss=_hdrBase+_shrinkCss; (function(){ var _h=document.querySelector('header.site'); if(!_h) return; if(_hs==='shrink'){ if(!_h.__lpScroll){ _h.__lpScroll=function(){ if(window.scrollY>60) _h.classList.add('lp-shrunk'); else _h.classList.remove('lp-shrunk'); }; window.addEventListener('scroll',_h.__lpScroll,{passive:true}); } _h.__lpScroll(); } else { _h.classList.remove('lp-shrunk'); if(_h.__lpScroll){ window.removeEventListener('scroll',_h.__lpScroll); _h.__lpScroll=null; } } })(); var _st=document.getElementById('lp-logo-css'); if(!_st){ _st=document.createElement('style'); _st.id='lp-logo-css'; document.head.appendChild(_st); } _st.textContent='header.site .bar{height:auto;min-height:70px;padding-top:10px;padding-bottom:10px}'+'a.brand{max-width:100%}'+_hdrCss+'a.brand .lp-logo-wrap{display:inline-flex;align-items:center;background:'+_lbg+';padding:'+_lpad+'px;border-radius:'+_lrad+'px;line-height:0}'+'a.brand img.lp-logo{height:'+_lhd+'px;width:auto;max-width:min(62vw,440px);object-fit:contain;display:block}'+'@media(max-width:760px){a.brand img.lp-logo{height:'+_lhm+'px;max-width:72vw}}'; for(var i=0;i<brands.length;i++){ var a=brands[i]; if(a.__orig==null) a.__orig=a.innerHTML; if(L.mode==='image'&&L.imageUrl){ a.innerHTML='<span class="lp-logo-wrap"><img class="lp-logo" src="'+esc(L.imageUrl)+'" alt="'+esc(L.text||'')+'"></span>'; a.style.transform=''; } else { a.innerHTML=a.__orig; var mark=a.querySelector('.mark'), nm=a.querySelector('.nm'); if(L.mode==='text'&&mark) mark.style.display='none'; if(nm&&L.text){ var sm=nm.querySelector('small'); nm.textContent=L.text; if(sm) nm.appendChild(sm); } a.style.transformOrigin='left center'; var _ls=_lhd/40; a.style.transform=(_ls!==1?'scale('+_ls+')':''); } var _inHN=(C.sections&&C.sections.navMenu&&C.sections.navMenu.on===true&&C.sections.navMenu.placement==='header'); if(_inHN){ a.style.marginLeft=''; a.style.marginRight=''; } else { a.style.marginLeft=((_lp==='right'||_lp==='center')?'auto':''); a.style.marginRight=((_lp==='center')?'auto':''); } } }
    if(C.logo){ var L=C.logo, brands=document.querySelectorAll('a.brand'); var _lhd=Math.max(20,Math.min(320,(L.heightPx?L.heightPx:Math.round(40*(L.scale||1)))||44)); var _lhm=Math.max(16,Math.min(200,(L.heightPxM?L.heightPxM:Math.round(_lhd*0.72)))); var _lbg=(L.bg&&L.bg!=='transparent')?L.bg:'transparent'; var _lpad=(L.pad!=null?L.pad:(_lbg!=='transparent'?8:0)); var _lrad=(L.radius!=null?L.radius:(_lbg!=='transparent'?12:0)); var _lp=L.position||'left'; var _hs=L.headerStyle||(L.float?'float':'solid-sticky'); var _hbg=(L.headerBg&&L.headerBg!=='')?L.headerBg:''; var _hop=L.headerBgOpacity; var _hopa=1; if(_hop!=null&&_hop!==''){ var _hopn=parseFloat(_hop); if(!isNaN(_hopn)) _hopa=Math.max(0,Math.min(100,_hopn))/100; } function _lgHexRgba(hex,a){ var m=/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.exec(String(hex||'').trim()); if(!m) return ''; var h=m[1]; if(h.length===3) h=h[0]+h[0]+h[1]+h[1]+h[2]+h[2]; var n=parseInt(h,16); return 'rgba('+((n>>16)&255)+','+((n>>8)&255)+','+(n&255)+','+a+')'; } var _hbgBase=_hbg||((_hopa<1)?'#0b1220':''); var _hbgCss=_hbgBase?(_hopa<=0?'transparent':(_hopa<1?(_lgHexRgba(_hbgBase,_hopa)||_hbgBase):_hbgBase)):''; var _pos='sticky',_top=';top:var(--emerg-sticky-h,0px)',_bg=(_hbgCss?(';background:'+_hbgCss):''); if(_hs==='solid-scroll'){ _pos='relative'; _top=''; } else if(_hs==='float'){ _pos='absolute'; _top=';top:0;left:0;right:0'; _bg=';background:transparent;box-shadow:none'; } else if(_hs==='shrink'){ _pos='sticky'; _top=';top:var(--emerg-sticky-h,0px)'; _bg=';background:transparent;box-shadow:none'; } var _stTopOn=L.headerStrokeTopOn===true; var _stBotOn=L.headerStrokeBottomOn===true; var _stTopW=Math.max(0,Math.min(16,+(L.headerStrokeTopWidth!=null?L.headerStrokeTopWidth:2)||0)); var _stBotW=Math.max(0,Math.min(16,+(L.headerStrokeBottomWidth!=null?L.headerStrokeBottomWidth:2)||0)); var _stTopC=(L.headerStrokeTopColor&&String(L.headerStrokeTopColor).trim())||'#ffffff'; var _stBotC=(L.headerStrokeBottomColor&&String(L.headerStrokeBottomColor).trim())||'#ffffff'; var _stroke=';border-top:'+(_stTopOn&&_stTopW>0?(_stTopW+'px solid '+_stTopC):'0')+';border-bottom:'+(_stBotOn&&_stBotW>0?(_stBotW+'px solid '+_stBotC):'0'); var _hdrBase='header.site{position:'+_pos+_top+';z-index:60'+_bg+_stroke+'}'; var _shrinkBg=_hbgCss||(_hbgBase?(_lgHexRgba(_hbgBase,0.94)||_hbgBase):'rgba(10,12,18,.94)'); var _shrinkCss=(_hs==='shrink')?('header.site{transition:background .25s,box-shadow .25s}header.site img.lp-logo{transition:height .25s}'+'header.site.lp-shrunk{background:'+_shrinkBg+';box-shadow:0 6px 24px rgba(0,0,0,.28)}'+'header.site.lp-shrunk .bar{min-height:0;padding-top:6px;padding-bottom:6px}'+'header.site.lp-shrunk a.brand{margin-left:0;margin-right:auto}'+'header.site.lp-shrunk img.lp-logo{height:'+Math.min(_lhd,52)+'px}'):''; var _hdrCss=_hdrBase+_shrinkCss; (function(){ var _h=document.querySelector('header.site'); if(!_h) return; if(_hs==='shrink'){ if(!_h.__lpScroll){ _h.__lpScroll=function(){ if(window.scrollY>60) _h.classList.add('lp-shrunk'); else _h.classList.remove('lp-shrunk'); }; window.addEventListener('scroll',_h.__lpScroll,{passive:true}); } _h.__lpScroll(); } else { _h.classList.remove('lp-shrunk'); if(_h.__lpScroll){ window.removeEventListener('scroll',_h.__lpScroll); _h.__lpScroll=null; } } })(); var _st=document.getElementById('lp-logo-css'); if(!_st){ _st=document.createElement('style'); _st.id='lp-logo-css'; document.head.appendChild(_st); } _st.textContent='header.site .bar{height:auto;min-height:70px;padding-top:10px;padding-bottom:10px}'+'a.brand{max-width:100%}'+_hdrCss+'a.brand .lp-logo-wrap{display:inline-flex;align-items:center;background:'+_lbg+';padding:'+_lpad+'px;border-radius:'+_lrad+'px;line-height:0}'+'a.brand img.lp-logo{height:'+_lhd+'px;width:auto;max-width:min(62vw,440px);object-fit:contain;display:block}'+'@media(max-width:760px){a.brand img.lp-logo{height:'+_lhm+'px;max-width:72vw}}'; for(var i=0;i<brands.length;i++){ var a=brands[i]; if(a.__orig==null) a.__orig=a.innerHTML; if(L.mode==='image'&&L.imageUrl){ a.innerHTML='<span class="lp-logo-wrap"><img class="lp-logo" src="'+esc(L.imageUrl)+'" alt="'+esc(L.text||'')+'"></span>'; a.style.transform=''; } else { a.innerHTML=a.__orig; var mark=a.querySelector('.mark'), nm=a.querySelector('.nm'); if(L.mode==='text'&&mark) mark.style.display='none'; if(nm&&L.text){ var sm=nm.querySelector('small'); nm.textContent=L.text; if(sm) nm.appendChild(sm); } a.style.transformOrigin='left center'; var _ls=_lhd/40; a.style.transform=(_ls!==1?'scale('+_ls+')':''); } var _inHN=(C.sections&&C.sections.navMenu&&C.sections.navMenu.on===true&&C.sections.navMenu.placement==='header'); if(_inHN){ a.style.marginLeft=''; a.style.marginRight=''; } else { a.style.marginLeft=((_lp==='right'||_lp==='center')?'auto':''); a.style.marginRight=((_lp==='center')?'auto':''); } } }
    if(C.logo){ var L=C.logo, brands=document.querySelectorAll('a.brand'); var _lhd=Math.max(20,Math.min(320,(L.heightPx?L.heightPx:Math.round(40*(L.scale||1)))||44)); var _lhm=Math.max(16,Math.min(200,(L.heightPxM?L.heightPxM:Math.round(_lhd*0.72)))); var _lbg=(L.bg&&L.bg!=='transparent')?L.bg:'transparent'; var _lpad=(L.pad!=null?L.pad:(_lbg!=='transparent'?8:0)); var _lrad=(L.radius!=null?L.radius:(_lbg!=='transparent'?12:0)); var _lp=L.position||'left'; var _hs=L.headerStyle||(L.float?'float':'solid-sticky'); var _hbg=(L.headerBg&&L.headerBg!=='')?L.headerBg:''; var _hop=L.headerBgOpacity; var _hopa=1; if(_hop!=null&&_hop!==''){ var _hopn=parseFloat(_hop); if(!isNaN(_hopn)) _hopa=Math.max(0,Math.min(100,_hopn))/100; } function _lgHexRgba(hex,a){ var m=/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.exec(String(hex||'').trim()); if(!m) return ''; var h=m[1]; if(h.length===3) h=h[0]+h[0]+h[1]+h[1]+h[2]+h[2]; var n=parseInt(h,16); return 'rgba('+((n>>16)&255)+','+((n>>8)&255)+','+(n&255)+','+a+')'; } var _hbgBase=_hbg||((_hopa<1)?'#0b1220':''); var _hbgCss=_hbgBase?(_hopa<=0?'transparent':(_hopa<1?(_lgHexRgba(_hbgBase,_hopa)||_hbgBase):_hbgBase)):''; var _pos='sticky',_top=';top:0',_bg=(_hbgCss?(';background:'+_hbgCss):''); if(_hs==='solid-scroll'){ _pos='relative'; _top=''; } else if(_hs==='float'){ _pos='absolute'; _top=';top:0;left:0;right:0'; _bg=';background:transparent;box-shadow:none'; } else if(_hs==='shrink'){ _pos='sticky'; _bg=';background:transparent;box-shadow:none'; } var _hdrBase='header.site{position:'+_pos+_top+';z-index:60'+_bg+'}'; var _shrinkBg=_hbgCss||(_hbgBase?(_lgHexRgba(_hbgBase,0.94)||_hbgBase):'rgba(10,12,18,.94)'); var _shrinkCss=(_hs==='shrink')?('header.site{transition:background .25s,box-shadow .25s}header.site img.lp-logo{transition:height .25s}'+'header.site.lp-shrunk{background:'+_shrinkBg+';box-shadow:0 6px 24px rgba(0,0,0,.28)}'+'header.site.lp-shrunk .bar{min-height:0;padding-top:6px;padding-bottom:6px}'+'header.site.lp-shrunk a.brand{margin-left:0;margin-right:auto}'+'header.site.lp-shrunk img.lp-logo{height:'+Math.min(_lhd,52)+'px}'):''; var _hdrCss=_hdrBase+_shrinkCss; (function(){ var _h=document.querySelector('header.site'); if(!_h) return; if(_hs==='shrink'){ if(!_h.__lpScroll){ _h.__lpScroll=function(){ if(window.scrollY>60) _h.classList.add('lp-shrunk'); else _h.classList.remove('lp-shrunk'); }; window.addEventListener('scroll',_h.__lpScroll,{passive:true}); } _h.__lpScroll(); } else { _h.classList.remove('lp-shrunk'); if(_h.__lpScroll){ window.removeEventListener('scroll',_h.__lpScroll); _h.__lpScroll=null; } } })(); var _st=document.getElementById('lp-logo-css'); if(!_st){ _st=document.createElement('style'); _st.id='lp-logo-css'; document.head.appendChild(_st); } _st.textContent='header.site .bar{height:auto;min-height:70px;padding-top:10px;padding-bottom:10px}'+'a.brand{max-width:100%}'+_hdrCss+'a.brand .lp-logo-wrap{display:inline-flex;align-items:center;background:'+_lbg+';padding:'+_lpad+'px;border-radius:'+_lrad+'px;line-height:0}'+'a.brand img.lp-logo{height:'+_lhd+'px;width:auto;max-width:min(62vw,440px);object-fit:contain;display:block}'+'@media(max-width:760px){a.brand img.lp-logo{height:'+_lhm+'px;max-width:72vw}}'; for(var i=0;i<brands.length;i++){ var a=brands[i]; if(a.__orig==null) a.__orig=a.innerHTML; if(L.mode==='image'&&L.imageUrl){ a.innerHTML='<span class="lp-logo-wrap"><img class="lp-logo" src="'+esc(L.imageUrl)+'" alt="'+esc(L.text||'')+'"></span>'; a.style.transform=''; } else { a.innerHTML=a.__orig; var mark=a.querySelector('.mark'), nm=a.querySelector('.nm'); if(L.mode==='text'&&mark) mark.style.display='none'; if(nm&&L.text){ var sm=nm.querySelector('small'); nm.textContent=L.text; if(sm) nm.appendChild(sm); } a.style.transformOrigin='left center'; var _ls=_lhd/40; a.style.transform=(_ls!==1?'scale('+_ls+')':''); } var _inHN=(C.sections&&C.sections.navMenu&&C.sections.navMenu.on===true&&C.sections.navMenu.placement==='header'); if(_inHN){ a.style.marginLeft=''; a.style.marginRight=''; } else { a.style.marginLeft=((_lp==='right'||_lp==='center')?'auto':''); a.style.marginRight=((_lp==='center')?'auto':''); } } }
    if(C.logo){ var L=C.logo, brands=document.querySelectorAll('a.brand'); var _lhd=Math.max(20,Math.min(320,(L.heightPx?L.heightPx:Math.round(40*(L.scale||1)))||44)); var _lhm=Math.max(16,Math.min(200,(L.heightPxM?L.heightPxM:Math.round(_lhd*0.72)))); var _lbg=(L.bg&&L.bg!=='transparent')?L.bg:'transparent'; var _lpad=(L.pad!=null?L.pad:(_lbg!=='transparent'?8:0)); var _lrad=(L.radius!=null?L.radius:(_lbg!=='transparent'?12:0)); var _lp=L.position||'left'; var _hs=L.headerStyle||(L.float?'float':'solid-sticky'); var _hbg=(L.headerBg&&L.headerBg!=='')?L.headerBg:''; var _hop=L.headerBgOpacity; var _hopa=1; if(_hop!=null&&_hop!==''){ var _hopn=parseFloat(_hop); if(!isNaN(_hopn)) _hopa=Math.max(0,Math.min(100,_hopn))/100; } function _lgHexRgba(hex,a){ var m=/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.exec(String(hex||'').trim()); if(!m) return ''; var h=m[1]; if(h.length===3) h=h[0]+h[0]+h[1]+h[1]+h[2]+h[2]; var n=parseInt(h,16); return 'rgba('+((n>>16)&255)+','+((n>>8)&255)+','+(n&255)+','+a+')'; } var _hbgBase=_hbg||((_hopa<1)?'#0b1220':''); var _hbgCss=_hbgBase?(_hopa<=0?'transparent':(_hopa<1?(_lgHexRgba(_hbgBase,_hopa)||_hbgBase):_hbgBase)):''; var _pos='sticky',_top=';top:var(--emerg-sticky-h,0px)',_bg=(_hbgCss?(';background:'+_hbgCss):''); if(_hs==='solid-scroll'){ _pos='relative'; _top=''; } else if(_hs==='float'){ _pos='absolute'; _top=';top:0;left:0;right:0'; _bg=';background:transparent;box-shadow:none'; } else if(_hs==='shrink'){ _pos='sticky'; _top=';top:var(--emerg-sticky-h,0px)'; _bg=';background:transparent;box-shadow:none'; } var _hdrBase='header.site{position:'+_pos+_top+';z-index:60'+_bg+'}'; var _shrinkBg=_hbgCss||(_hbgBase?(_lgHexRgba(_hbgBase,0.94)||_hbgBase):'rgba(10,12,18,.94)'); var _shrinkCss=(_hs==='shrink')?('header.site{transition:background .25s,box-shadow .25s}header.site img.lp-logo{transition:height .25s}'+'header.site.lp-shrunk{background:'+_shrinkBg+';box-shadow:0 6px 24px rgba(0,0,0,.28)}'+'header.site.lp-shrunk .bar{min-height:0;padding-top:6px;padding-bottom:6px}'+'header.site.lp-shrunk a.brand{margin-left:0;margin-right:auto}'+'header.site.lp-shrunk img.lp-logo{height:'+Math.min(_lhd,52)+'px}'):''; var _hdrCss=_hdrBase+_shrinkCss; (function(){ var _h=document.querySelector('header.site'); if(!_h) return; if(_hs==='shrink'){ if(!_h.__lpScroll){ _h.__lpScroll=function(){ if(window.scrollY>60) _h.classList.add('lp-shrunk'); else _h.classList.remove('lp-shrunk'); }; window.addEventListener('scroll',_h.__lpScroll,{passive:true}); } _h.__lpScroll(); } else { _h.classList.remove('lp-shrunk'); if(_h.__lpScroll){ window.removeEventListener('scroll',_h.__lpScroll); _h.__lpScroll=null; } } })(); var _st=document.getElementById('lp-logo-css'); if(!_st){ _st=document.createElement('style'); _st.id='lp-logo-css'; document.head.appendChild(_st); } _st.textContent='header.site .bar{height:auto;min-height:70px;padding-top:10px;padding-bottom:10px}'+'a.brand{max-width:100%}'+_hdrCss+'a.brand .lp-logo-wrap{display:inline-flex;align-items:center;background:'+_lbg+';padding:'+_lpad+'px;border-radius:'+_lrad+'px;line-height:0}'+'a.brand img.lp-logo{height:'+_lhd+'px;width:auto;max-width:min(62vw,440px);object-fit:contain;display:block}'+'@media(max-width:760px){a.brand img.lp-logo{height:'+_lhm+'px;max-width:72vw}}'; for(var i=0;i<brands.length;i++){ var a=brands[i]; if(a.__orig==null) a.__orig=a.innerHTML; if(L.mode==='image'&&L.imageUrl){ a.innerHTML='<span class="lp-logo-wrap"><img class="lp-logo" src="'+esc(L.imageUrl)+'" alt="'+esc(L.text||'')+'"></span>'; a.style.transform=''; } else { a.innerHTML=a.__orig; var mark=a.querySelector('.mark'), nm=a.querySelector('.nm'); if(L.mode==='text'&&mark) mark.style.display='none'; if(nm&&L.text){ var sm=nm.querySelector('small'); nm.textContent=L.text; if(sm) nm.appendChild(sm); } a.style.transformOrigin='left center'; var _ls=_lhd/40; a.style.transform=(_ls!==1?'scale('+_ls+')':''); } var _inHN=(C.sections&&C.sections.navMenu&&C.sections.navMenu.on===true&&C.sections.navMenu.placement==='header'); if(_inHN){ a.style.marginLeft=''; a.style.marginRight=''; } else { a.style.marginLeft=((_lp==='right'||_lp==='center')?'auto':''); a.style.marginRight=((_lp==='center')?'auto':''); } } }
    var SEC=C.sections||{};
    ...
    (function(){ var S=C.sections||{};
      ...
      if(em){
        ...
        if(_emTrans){ em.style.setProperty('--emerg-bg','transparent'); }
        else { var _ebg=_emHex(E.bg); if(_ebg) em.style.setProperty('--emerg-bg',_ebg); else em.style.removeProperty('--emerg-bg'); }
