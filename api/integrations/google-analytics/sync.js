 ...
 * { siteId, days? } — pull GA4 landing pages into si_ga4_landing_stats
 */

const { createClient } = require('@supabase/supabase-js');
const { syncGa4Site } = require('../../../lib/search-intelligence/sync');
...
module.exports = async (req, res) => {
  ...
  const result = await syncGa4Site(admin, conn, { days: days });
