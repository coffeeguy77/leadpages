...
/* Paint reserved body padding so no light gap shows between dark LP footer and fixed buy bar */
'#lpFooter.lp-foot,#lpFooter{padding-bottom:calc(28px + 76px)!important;margin-bottom:-76px!important;background:#0e1116}' +
...
'@media(max-width:560px){body{padding-bottom:96px}#lpFooter.lp-foot,#lpFooter{padding-bottom:calc(28px + 96px)!important;margin-bottom:-96px!important}.lpbuy-bar-in{justify-content:center;text-align:center}.lpbuy-cta{width:100%}}' +
'</style>' +
'<script>(function(){' +
...
function injectOnlineQuote(html, slug, cfg) {
  ...
  const QUOTE_SCRIPTS = [
    '/assets/lp-quote-wizard-logic.js?v=oq-event-cal-compact-1',
    '/assets/lp-quote-display.js?v=oq-event-cal-compact-1',
    '/assets/lp-quote-planning.js?v=oq-event-cal-compact-1',
    '/assets/lp-online-quote.js?v=oq-event-cal-compact-1'
  ];
  ...
  const block =
    ...
    '</div></section>' +
    '<script src="/assets/lp-quote-wizard-logic.js?v=oq-event-cal-compact-1" defer></script>' +
    '<script src="/assets/lp-quote-display.js?v=oq-event-cal-compact-1" defer></script>' +
    '<script src="/assets/lp-quote-planning.js?v=oq-event-cal-compact-1" defer></script>' +
    '<script src="/assets/lp-online-quote.js?v=oq-event-cal-compact-1" defer></script>';
