...
function injectOnlineQuote(html, slug, cfg) {
  ...
  const QUOTE_SCRIPTS = [
    '/assets/lp-quote-wizard-logic.js?v=oq-pkg-style-2',
    '/assets/lp-quote-display.js?v=oq-pkg-style-2',
    '/assets/lp-quote-planning.js?v=oq-pkg-style-2',
    '/assets/lp-online-quote.js?v=oq-pkg-style-2'
  ];
  ...
  const block =
    ...
    '</div></section>' +
    '<script src="/assets/lp-quote-wizard-logic.js?v=oq-pkg-style-2" defer></script>' +
    '<script src="/assets/lp-quote-display.js?v=oq-pkg-style-2" defer></script>' +
    '<script src="/assets/lp-quote-planning.js?v=oq-pkg-style-2" defer></script>' +
    '<script src="/assets/lp-online-quote.js?v=oq-pkg-style-2" defer></script>';
