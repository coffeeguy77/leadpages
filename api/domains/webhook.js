...
function auEligibility(reg) {
  ...
  if (reg.business_name) out.push({ name: 'business_name', value: reg.business_name });
  if (reg.business_number) out.push({ name: 'business_number', value: reg.business_number });
  return out;
}
