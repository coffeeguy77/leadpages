...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-step-nav-1'), 'cache-busted builder css');
assert.ok(manage.includes('lp-quote-display.js?v=oq-step-nav-1'), 'cache-busted display js');
assert.ok(manage.includes('lp-quote-builder.js?v=oq-step-nav-1'), 'cache-busted builder js');
assert.ok(render.includes('lp-quote-display.js?v=oq-step-nav-1'), 'public render cache-bust');
