...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-ux-whitelist-1'), 'cache-busted css');
assert.ok(render.includes('oq-ux-whitelist-1'), 'public render cache-bust');
