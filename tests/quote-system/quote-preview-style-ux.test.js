...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-verify-portal-1'), 'cache-busted css');
assert.ok(render.includes('oq-verify-portal-1'), 'public render cache-bust');
