...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-travel-cards-1'), 'cache-busted css');
assert.ok(render.includes('oq-travel-cards-1'), 'public render cache-bust');
