...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-event-cal-live-1'), 'cache-busted css');
assert.ok(render.includes('oq-event-cal-live-1'), 'public render cache-bust');
