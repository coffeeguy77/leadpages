...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-event-cal-compact-1'), 'cache-busted css');
assert.ok(render.includes('oq-event-cal-compact-1'), 'public render cache-bust');
