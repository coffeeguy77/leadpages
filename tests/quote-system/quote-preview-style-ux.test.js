...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-align-fields-1'), 'cache-busted css');
assert.ok(render.includes('oq-align-fields-1'), 'public render cache-bust');
