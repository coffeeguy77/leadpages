...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-portal-access-1'), 'cache-busted css');
assert.ok(render.includes('oq-portal-access-1'), 'public render cache-bust');
