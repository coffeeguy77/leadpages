...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-verify-portal-2'), 'cache-busted css');
assert.ok(render.includes('oq-verify-portal-2'), 'public render cache-bust');
