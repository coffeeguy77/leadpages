...
assert.ok(manage.includes('lp-quote-builder.css?v=oq-portal-style-1'), 'cache-busted css');
assert.ok(render.includes('oq-portal-style-1'), 'public render cache-bust');
