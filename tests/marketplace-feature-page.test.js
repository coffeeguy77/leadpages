...
describe('marketplace feature app demo page', () => {
  ...
  it('supports portrait, landscape, and dual playground layouts', () => {
    assert.match(featureHtml, /data-layout="portrait"/);
    assert.match(featureHtml, /data-layout="landscape"/);
    assert.match(featureHtml, /data-layout="dual"/);
    assert.match(featureHtml, /pg-layoutbtns/);
    assert.match(featureHtml, /pg-dual-strip/);
    assert.match(featureHtml, /var layout = 'portrait'/);
    assert.match(featureHtml, /var dev = 'tablet'/);
    assert.match(featureHtml, /function setLayout/);
    assert.match(featureHtml, /function ensureDualMounted/);
    assert.match(featureCss, /\[data-layout="landscape"\]/);
  });
