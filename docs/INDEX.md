...
| **Layout Composer (Phase 2)** | [features/Layout-Composer-Architecture](features/Layout-Composer-Architecture.md) | Layout-first creation; Themes as presets; trade-pack bug notes |
