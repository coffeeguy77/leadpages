...
- **Competition tab:** Semrush-style Domain Overview rivals → Keyword Gap (Missing / Weak) → Backlink referring domains → Paid keyword research (DataForSEO Labs; Semrush APIs out of scope)  
- Local tab: NAP, opportunity map, Maps grid, CRM multi-location outcomes (first-party leads)  
